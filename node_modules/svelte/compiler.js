	...
	class Component {
	    ...
	    generate(result) {
	        ...
	        if (result) {
	            ...
	            const banner = `/* ${this.file ? `${this.file} ` : ``}generated by Svelte v${"3.6.8"} */`;
	            result = result
